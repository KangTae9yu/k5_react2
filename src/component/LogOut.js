                    ...
                    <div className="bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <Link to='/' onClick={onLogout} className="w-full flex justify-center items-center bg-blue-600 hover:bg-sky-400 text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign out</Link>
                            </form>
                        </div>
                    </div>
                </div>
